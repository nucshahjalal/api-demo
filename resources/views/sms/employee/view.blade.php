            ...
            <div class="page-header-right ms-auto">
                <div class="page-header-right-items">
                    ...
                    <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                        <a href="{{ url('employee/list') }}" class="btn btn-sm btn-lg btn-primary w-100 text-white fw-bold" style="font-size: 20px;">
                            ← Back
                        </a>
                    </div>
                </div>
                                ...
                                <form action="{{ route('employee.update') }}" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <input class="form-control" type="text" name="emp_id"  value="{{ $employee->emp_id }}" id="emp_id" placeholder="Emp ID" readonly>
                                        </div> 
                                    </div>
                                    <div class="row">     
                                        <div class="col-lg-6 mb-3">
